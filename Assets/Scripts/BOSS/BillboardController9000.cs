...
public class BillboardController9000 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        _thisTransform.rotation = Quaternion.Euler(new Vector3(_initialRotation.x, _thisTransform.rotation.eulerAngles.y-180, _initialRotation.z));
    }
}
